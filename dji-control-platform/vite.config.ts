...
export default defineConfig(({ mode }) => {
  ...
  const getProxyTarget = () => {
    ...
    if (environment === 'internet') {
      console.log('🔧 Vite配置 - 使用外网代理:', 'http://10.10.1.36:8000')
      return 'http://10.10.1.36:8000'
    } else {
      console.log('🔧 Vite配置 - 使用内网代理:', 'http://192.168.111.101:8000')
      return 'http://192.168.111.101:8000'
    }
  }
